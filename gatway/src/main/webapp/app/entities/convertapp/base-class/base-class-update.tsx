...
export class BaseClassUpdate extends React.Component<IBaseClassUpdateProps, IBaseClassUpdateState> {
  ...
  render() {
    const { baseClassEntity, loading, updating } = this.props;
    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="gatwayApp.convertappBaseClass.home.createOrEditLabel">Create or edit a BaseClass</h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
          <Col md="8">
            {loading ? (
              ...
              <AvForm model={isNew ? {} : baseClassEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  ...
                  <AvField id="base-class-nom" type="text" name="nom" />
                </AvGroup>
                <AvGroup>
                  <Label id="importsLabel" for="imports">
                    Imports
                  </Label>
                  <AvField id="base-class-imports" type="text" name="imports" />
                </AvGroup>
