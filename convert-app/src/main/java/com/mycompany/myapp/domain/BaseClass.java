...
public class BaseClass implements Serializable {
    ...
    public BaseClass builderPlates(Set<BuilderPlate> builderPlates) {
        this.builderPlates = builderPlates;
        return this;
    }

    public BaseClass addBuilderPlate(BuilderPlate builderPlate) {
        this.builderPlates.add(builderPlate);
        builderPlate.setBaseClass(this);
        return this;
    }

    public BaseClass removeBuilderPlate(BuilderPlate builderPlate) {
        this.builderPlates.remove(builderPlate);
        builderPlate.setBaseClass(null);
        return this;
    }
